...
struct MatchesView: View {
    ...
    var body: some View {
        ZStack(alignment: .top) {
                    ...
                    VStack {
                        HStack {
                            VStack(alignment: .leading, spacing: 6) {
                                ...
                                Text("Make your move, they are waiting 🎵")
                                    .font(.ProximaNova(.light, size: 12))
                        ...
                        ScrollView(.horizontal, showsIndicators: false) {
                            HStack(spacing: 15) {
                                Spacer()
                                    .frame(width: 5)
                                MatchesCell(image: "Amanda", name: "Amanda", age: 22, message: "What is your most favorite childhood memory?", type: .hidden)
                                MatchesCell(image: "Malte", name: "Malte", age: 31, message: "What is the most important quality in friendships to you?", type: .makeMove)
                        ...
                        VStack(alignment: .leading) {
                            VStack(alignment: .leading, spacing: 10) {
                                HStack(spacing: 12) {
                                    ...
                                    VStack(alignment: .leading, spacing: 4) {
                                        Text("Pending")
                                            .font(.ProximaNova(.bold, size: 22))                            .foregroundStyle(Color.disableColor)
                                        Rectangle()
                                            .fill(Color.white)
                                            .frame(height: 1)
                                            .frame(width: 52)
            ...
            .scrollBounceBehavior(.basedOnSize) // default behavior
        }
